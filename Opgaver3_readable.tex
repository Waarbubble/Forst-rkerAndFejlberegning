...
\subsection{C2}
Dominant-pole op-amp with $A_{0,OL}=50{,}000$ and $f_{BOL}=\SI{100}{Hz}$. Sketch magnitude Bode plot of $A_{OL}$ to scale.

\subsection{C3}
Op-amp with $A_{0,OL}=200{,}000$ and 3-dB bandwidth \SI{5}{Hz}. Find magnitude and phase of open-loop gain at \SI{100}{Hz}, \SI{1000}{Hz}, and \SI{1}{MHz}.
...
\]
\begin{itemize}
\item $f=\SI{100}{Hz}$: $f/f_c=20$, $|A|\approx 9990$ (\SI{79.99}{dB}), phase $\approx-87.1^\circ$.
\item $f=\SI{1000}{Hz}$: $f/f_c=200$, $|A|\approx1000$ (\SI{60.00}{dB}), phase $\approx-89.7^\circ$.
\item $f=\SI{1}{MHz}$: $f/f_c=200000$, $|A|\approx1$ (\SI{0}{dB}), phase $\approx-90^\circ$.
\end{itemize}
...
\[
\left(1+(f/f_{B2})^2\right)^2=2 \Rightarrow f\approx0.6436f_{B2}=\SI{64.4}{kHz}.
\]
