...
\subsection{D4}
Non-inverting amplifier with \(\mu\)A741C at \SI{25}{\celsius}, \SIrange{-15}{15}{V}, $R_1=\SI{10}{k\Omega}$ and $R_2=\SI{470}{k\Omega}$. Ignore source resistance and finite gain/bandwidth, but include offset and bias errors. Compute maximum output error.
...
$A_{0,OL}=\SI{100}{dB}$, $f_{BOL}=\SI{10}{Hz}$.
...
\item Use arithmetic worst-case summation of absolute values (not RSS): choose error signs so contributions add in output magnitude.
\end{enumerate}
